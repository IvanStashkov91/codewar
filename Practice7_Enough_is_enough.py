...
He isn't fond of seeing the Eiffel tower 40 times. He tells them that he will only sit during the session
...
delete_nth([1, 2, 4, 1, 4, 4, 4, 2, 2], 2)
...
def delete_nth(order, max_e):
    result = []
    [result.append(i) for i in order if result.count(i) < max_e]
    return result
...
print(delete_nth([1, 2, 4, 1, 4, 4, 4, 2, 2], 2))
